...
from pynucastro.rates import ApproximateRate, Rate
...
class ScreeningPair:
    ...
    def __init__(self, name: str, nuc1: Nucleus, nuc2: Nucleus, rate: Rate = None) -> None:
        self.name = name
        self.n1 = nuc1
        self.n2 = nuc2
...
def get_screening_map(rates: list[Rate], *, symmetric_screening: bool = False) -> list[ScreeningPair]:
